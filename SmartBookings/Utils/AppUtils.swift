...
class AppUtil {
   ...
   public static var buttonbgYellow: String = "FEBB12"
   public static var searchtypes: [String] = ["Hotel","Apartment","Stadium","Chalets","Farms","Resorts","Camps","Lounges","Wedding halls"]
